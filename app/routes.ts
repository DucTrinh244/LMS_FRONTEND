...
export default [
  ...
  route('checkout/:courseId?', 'module/landing/pages/checkoutPage.tsx'),
  route('payment/callback', 'module/landing/pages/PaymentCallbackPage.tsx'),
  route('payment/success', 'module/landing/pages/PaymentSuccessPage.tsx'),
  ...
  route('wishlist', 'module/landing/pages/WishlistPage.tsx'),
  ...
  route('become-instructor', 'module/landing/pages/BecomeInstructorPage.tsx'),
