              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className={`appearance-none block w-full px-3 py-2 border rounded-md shadow-sm 
                    ...
                    focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 sm:text-sm ${errors.email ? 'border-red-400 focus:ring-red-400 focus:border-red-400' : 'border-slate-600'
                    }`}
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className={`appearance-none block w-full px-3 py-2 border rounded-md shadow-sm 
                    text-white placeholder-slate-400 bg-slate-700 
                    focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 sm:text-sm ${errors.password ? 'border-red-400 focus:ring-red-400 focus:border-red-400' : 'border-slate-600'
                    }`}
