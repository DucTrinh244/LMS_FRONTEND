      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            >
              <a href="#courses" className="flex items-center gap-1 px-4 py-2 text-slate-300 hover:text-white rounded-lg hover:bg-slate-800 transition">
                Courses
              ...
              {courseDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-slate-800 rounded-lg shadow-lg border border-slate-700 py-3 z-50">
                  ...
                  <a href="#programming" className="block px-4 py-3 text-slate-300 hover:bg-slate-700 hover:text-white transition group">
                    <div className="flex items-center gap-3">
